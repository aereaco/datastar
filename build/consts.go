...
var Consts = &ConstTemplateData{
	DoNotEdit: "This is auto-generated by Nexus-UX. DO NOT EDIT.",
	SDKLanguages: []Language{
		{
			Handle: "clojure",
			Name:   "Clojure",
			Icon:   "vscode-icons:file-type-clojure",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/clojure",
		},
		{
			Handle: "csharp",
			Name:   "C#",
			Icon:   "vscode-icons:file-type-csharp2",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/dotnet",
		},
		{
			Handle: "go",
			Name:   "Go",
			Icon:   "vscode-icons:file-type-go-gopher",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/go",
		},
		{
			Handle: "haskell",
			Name:   "Haskell",
			Icon:   "vscode-icons:file-type-haskell",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/haskell",
		},
		{
			Handle: "java",
			Name:   "Java",
			Icon:   "vscode-icons:file-type-java",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/java",
		},
		{
			Handle: "php",
			Name:   "PHP",
			Icon:   "vscode-icons:file-type-php",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/php",
		},
		{
			Handle: "python",
			Name:   "Python",
			Icon:   "vscode-icons:file-type-python",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/python",
		},
		{
			Handle: "rust",
			Name:   "Rust",
			Icon:   "vscode-icons:file-type-rust",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/rust",
		},
		{
			Handle: "ruby",
			Name:   "Ruby",
			Icon:   "vscode-icons:file-type-ruby",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/ruby",
		},
		{
			Handle: "typescript",
			Name:   "TypeScript",
			Icon:   "vscode-icons:file-type-typescript-official",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/typescript",
		},
		{
			Handle: "zig",
			Name:   "Zig",
			Icon:   "vscode-icons:file-type-zig",
			SdkUrl: "https://github.com/aereaco/nexus-ux/tree/main/sdk/zig",
		},
	},
	StateKey: "state",
	DefaultBools: []*DefaultBool{
