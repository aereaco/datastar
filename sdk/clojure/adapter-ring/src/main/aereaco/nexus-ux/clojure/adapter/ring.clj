(ns aereaco.nexus-ux.clojure.adapter.ring
  (:require
    [aereaco.nexus-ux.clojure.adapter.ring.impl :as impl]
    [aereaco.nexus-ux.clojure.adapter.common :as ac]
    [aereaco.nexus-ux.clojure.utils :refer [def-clone]]))
...
(defn ->sse-response
  ...
  - [[on-exception]]: callback (fn [sse-gen e ctx] ...) that will be called when an exception is
  ...
  You can also take a look at the `aereaco.nexus-ux.clojure.adapter.common`
