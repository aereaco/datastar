...
cMergeFragments                          = "state-merge-fragments"
cMergeSignals                            :: StringLike a => a
cMergeSignals                            = "state-merge-signals"
cRemoveFragments                         :: StringLike a => a
cRemoveFragments                         = "state-remove-fragments"
cRemoveSignals                           :: StringLike a => a
cRemoveSignals                           = "state-remove-signals"
cExecuteScript                           :: StringLike a => a
cExecuteScript                           = "state-execute-script"
-- Added by Henry
