...
pub const state_key = "state";
pub const version = "0.0.1-alpha";
...
pub const EventType = enum {
    ...
    pub fn format(
        ...
        try writer.writeAll(
            switch (self) {
                .merge_fragments => "state-merge-fragments",
                .merge_signals => "state-merge-signals",
                .remove_fragments => "state-remove-fragments",
                .remove_signals => "state-remove-signals",
                .execute_script => "state-execute-script",
