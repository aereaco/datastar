...
import nexusux_py.consts as consts
...
# 0..N nexus-ux events
StateEvents: TypeAlias = Union[
    StateEvent, Iterable[StateEvent], AsyncIterable[StateEvent], None
]
...
class ServerSentEventGenerator:
    ...
    @classmethod
    def redirect(cls, location: str) -> StateEvent:
