...
#[allow(unused)]
pub(crate) const STATE_REQ_HEADER_STR: &str = "state-request";
#[expect(unused)]
pub(crate) const VERSION: &str = "0.0.1-alpha";
...
impl EventType {
    ...
    pub(crate) const fn as_str(&self) -> &str {
        match self {
            Self::MergeFragments => "state-merge-fragments",
            Self::MergeSignals => "state-merge-signals",
            Self::RemoveFragments => "state-remove-fragments",
            Self::RemoveSignals => "state-remove-signals",
            Self::ExecuteScript => "state-execute-script",
