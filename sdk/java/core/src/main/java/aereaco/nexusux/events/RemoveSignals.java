package aereaco.nexus-ux.events;

import aereaco.nexus-ux.enums.EventType;

import java.util.ArrayList;
import java.util.List;

import static aereaco.nexus-ux.Consts.PATHS_DATALINE_LITERAL;

public final class RemoveSignals extends AbstractStateEvent {
