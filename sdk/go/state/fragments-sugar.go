...
// MergeFragmentTempl is a convenience adaptor of [state.MergeFragments] for [TemplComponent].
...
// MergeFragmentGostar is a convenience adaptor of [state.MergeFragments] for [GoStarElementRenderer].
...
// GetSSE is a convenience method for generating Nexus-UX backend [get] action attribute.
//
// [get]: https://nexus.aerea.co/reference/action_plugins#get
func GetSSE(urlFormat string, args ...any) string {
	return fmt.Sprintf(`@get('%s')`, fmt.Sprintf(urlFormat, args...))
}

// PostSSE is a convenience method for generating Nexus-UX backend [post] action attribute.
//
// [post]: https://nexus.aerea.co/reference/action_plugins#post
func PostSSE(urlFormat string, args ...any) string {
	return fmt.Sprintf(`@post('%s')`, fmt.Sprintf(urlFormat, args...))
}

// PutSSE is a convenience method for generating Nexus-UX backend [put] action attribute.
//
// [put]: https://nexus.aerea.co/reference/action_plugins#put
func PutSSE(urlFormat string, args ...any) string {
	return fmt.Sprintf(`@put('%s')`, fmt.Sprintf(urlFormat, args...))
}

// PatchSSE is a convenience method for generating Nexus-UX backend [patch] action attribute.
//
// [patch]: https://nexus.aerea.co/reference/action_plugins#patch
func PatchSSE(urlFormat string, args ...any) string {
	return fmt.Sprintf(`@patch('%s')`, fmt.Sprintf(urlFormat, args...))
}

// DeleteSSE is a convenience method for generating Nexus-UX backend [delete] action attribute.
//
// [delete]: https://nexus.aerea.co/reference/action_plugins#delete
