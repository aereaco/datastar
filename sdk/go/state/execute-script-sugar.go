...
// ConsoleLog is a convenience method for [state.ExecuteScript].
// It is equivalent to calling [state.ExecuteScript] with [state.WithScript] option set to `console.log(msg)`.
...
// ConsoleLogf is a convenience method for [state.ExecuteScript].
// It is equivalent to calling [state.ExecuteScript] with [state.WithScript] option set to `console.log(fmt.Sprintf(format, args...))`.
func (sse *ServerSentEventGenerator) ConsoleLogf(format string, args ...any) error {
	return sse.ConsoleLog(fmt.Sprintf(format, args...))
}

// ConsoleError is a convenience method for [state.ExecuteScript].
// It is equivalent to calling [state.ExecuteScript] with [state.WithScript] option set to `console.error(msg)`.
...
// Redirectf is a convenience method for [state.ExecuteScript].
...
// Redirect is a convenience method for [state.ExecuteScript].
...
//
// [event bubbling]: https://developer.mozilla.org/en-US/docs/Web/API/Event/bubbling
...
// a client side script via [state.ExecuteScript] call. The detail struct is marshaled to JSON and
...
// ReplaceURLQuerystring is a convenience wrapper for [state.ReplaceURL] that replaces the query
...
// Prefetch is a convenience wrapper for [state.ExecuteScript] that prefetches the provided links.
