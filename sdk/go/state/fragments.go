...
// mergeFragmentOptions holds the configuration data for [state.MergeFragments] event.
...
// MergeFragmentOption configures the [state.MergeFragments] event initialization.
...
// for initialization of [state.RemoveFragments] event.
...
// RemoveFragmentsOption configures the [state.RemoveFragments] event.
